export const projects = [
  {
    title: "VM Memo Agent",
    description: "AI-driven DeFi research assistant that generates institutional-grade protocol analysis from on-chain, governance, tokenomics, and market data.",
    tech: ["React", "Express", "PostgreSQL"],
    github: "https://github.com/AdarshC0de/VM-Memo-Agent",
